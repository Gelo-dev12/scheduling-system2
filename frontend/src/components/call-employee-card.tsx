...
import { Phone, MessageCircle, Clock, User, Smartphone } from "lucide-react"
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-2">
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span className="text-xs text-gray-500">Employee from {request.fromBranch}</span>
                </div>
              </div>
            ...
            <div className="bg-white p-3 rounded border mb-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-medium text-red-600">No Response - Request Expired</span>
              </div>
              <div className="text-xs text-gray-600">
                <p>
                  <strong>Shift Request:</strong> {formatDate(request.shiftDate)} • {request.startTime}-
                  {request.endTime}
                </p>
                <p className="mt-1">
                  <strong>Status:</strong> Sent to employee's mobile app - No response after 5 minutes
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="text-xs text-gray-600 mb-2">
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    <strong>Employee Contact:</strong> {employee.phone}
                  </span>
                </div>
              </div>
              ...
              <div className="text-xs text-gray-500 text-center mt-2">
                💡 Call to discuss shift details or send SMS reminder
              </div>
            </div>
          </div>
        </div>
